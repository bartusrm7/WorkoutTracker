                    ...
                    <div class="modal-body">
                        <div class="profile__form-container">
                            <form action="/edit-profile" method="post">
                                ...
                                <div class="form-floating mb-2">
                                    <input class="form-control" step="0.05" min="30" max="180" value="<?= $userData['data']['weight'] ?>" type="number" name="weight" id="weight" required placeholder="">
                                    <label for="weight">Waga</label>
                                </div>
                                <div class="form-floating mb-2">
                                    <input class="form-control" step="0.05" min="30" max="180" value="<?= $userData['data']['goal_weight'] ?>" type="number" name="goal_weight" id="goal_weight" required placeholder="">
